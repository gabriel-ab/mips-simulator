...
class MipsCommandR(MipsCommand):
    ...
    def __str__(self) -> str:
        ...
        name = constants.FUNCTIONS[self.fn]
...
class MipsCommandI(MipsCommand):
    ...
    def __str__(self) -> str:
        name, rs, rt = constants.OPCODES[self.op], constants.REGS[self.rs], constants.REGS[self.rt]
...
class MipsCommandJ(MipsCommand):
    ...
    def __str__(self) -> str:
        return f'{constants.OPCODES[self.op]} {self.jump*4}'
